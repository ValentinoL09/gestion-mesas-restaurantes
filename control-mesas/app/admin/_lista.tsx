...
export type RestauranteConDetalles = Tables<'restaurantes'> & {
  email_dueño: string | null;
  cantidad_mesas: number;
  cantidad_sucursales: number;
};

export default function ListaAdmin({ restaurantes }: { restaurantes: RestauranteConDetalles[] }) {
            ...
            >
              ...
              <div className="flex items-center gap-2 flex-wrap">
                ...
                <button
                  ...
                  disabled={eliminando}
                  className="px-4 py-2 text-sm font-semibold rounded-lg bg-red-50 text-red-600 hover:bg-red-100 transition-colors disabled:opacity-40"
                >
                  Eliminar
                </button>
              </div>
